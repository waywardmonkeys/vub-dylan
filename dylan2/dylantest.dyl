...
define method tautology(arg == #"numbers")
  ...
  instance?(1.0, <single-float>)	| signal("1.0s0 is not a <single-float>!\n");
  instance?(1.0, <double-float>)	| signal("1.0d0 is not a <double-float>!\n");
  instance?(1.0, <extended-float>)	| signal("1.0x0 is not a <extended-float>!\n");
